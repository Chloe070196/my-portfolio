const fr = {
  about: "À Propos",
  aboutEmployeurPreference: "J'aime construire des application qui permet ou facilitent les apprentissages, et cherche à travailler pour une entreprise qui soit investie dans le domaine de l'éducation, ou de la communication.",
